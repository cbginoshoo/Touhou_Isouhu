...
/*:
 * @plugindesc  (3.0.0_custom1)ゲームパッドの設定を変更するプラグインです。
...
if(setting.hookPoint==='menu'){
    ...
    Window_Options.prototype.addGamepadOptions_MA =function(){
        if(setting.gamepadConfigEnabled){
            ...
            this.addCommand(setting.commandName,MA_GAMEPAD_CONFIG,!$gameParty.inBattle());
        }
    };
    Window_Options.prototype.addKeyboardConfig_MA=function(){
        if(setting.keyboardConfigEnabled){
            ...
            this.addCommand(setting.keyConfigCommandName,MA_KEYBOARD_CONFIG,!$gameParty.inBattle());
        }
    };
