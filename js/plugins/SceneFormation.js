 ...
 * @desc 並び替えシーンの背景画像です。(img/pictures以下に配置してください)
 * @type file
 * @require 1
 * @dir img/pictures
 * @default
...
(function() {
    ...
    var backgroundImage = String(parameters['Background Image']);
    ...
    Window_Formation.prototype.maxRows = function() {
        ...
        return Math.ceil(this.maxItems()/5);
    };
    ...
    Window_Formation.prototype.maxPageRows = function() {
        return this._type === 'battle' ? 1 : Math.min(Math.ceil(standMembersSize / 5),2);
    };
    ...
    Window_FormationStatus.prototype.refreshContents = function(){
        ...
        if (this._actor) {
            ...
            this.drawActorLevel(this._actor, 220, 0);
            this.drawActorClass(this._actor, 364, 0);
            this.drawActorNickname(this._actor, 520, 0);
    ...
    Window_FormationStatus.prototype.drawActorLevel = function(actor, x, y) {
        this.changeTextColor(this.systemColor());
        this.drawText(TextManager.levelA, x, y, 48);
        this.resetTextColor();
        this.drawText(actor.level, x + 96, y, 36, 'right');
    };
...
////////////////////////////////////////////////////////////////////////////////////
    ...
    var _Scene_Formation_createBackground = Scene_Formation.prototype.createBackground;
    Scene_Formation.prototype.createBackground = function(){
        if(backgroundImage){
            this._backgroundSprite = new Sprite();
            this._backgroundSprite.bitmap =
             ImageManager.loadPicture(backgroundImage);
            this.addChild(this._backgroundSprite);
            return;
        }
        // if background file is invalid, it does original process.
        _Scene_Formation_createBackground.call(this);
    };
