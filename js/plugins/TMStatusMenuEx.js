...
/*:
 * @plugindesc (v 1.0_custom_20200412)ステータスシーンに表示するパラメータを追加します。
 *
 ...
 * [更新履歴]
 * 2020/04/12
 *   ・ステータスウィンドウ左右に移動可能であることを示す矢印を追加。
 *   ・左右キーでステータス表示を切り替えられるように修正。
 *
 */
...
(function() {
    ...
    var useOkButton = parameters['useOkKey'] === '1' ? true : false;
    ...
    Window_Status.prototype.initialize = function() {
        ...
        this.createArrowParts();
        this.refreshArrows();
    };

    Window_Status.prototype.createArrowParts = function() {
    ...
    Window_Status.prototype.refreshArrows = function() {
        var w = this._width;
        var h = this._height;
        var p = 24;
        var q = p / 2;
